...
function main() {
    while true; do
        ...
        ui_widget_select -k install_pkgs open_update_pkgs_menu open_remove_pkgs_menu open_options exit_app -i "Install Package/s" "Update Package/s" "Remove Package/s" "Options" "Exit"
